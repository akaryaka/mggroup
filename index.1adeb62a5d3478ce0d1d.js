...
;// CONCATENATED MODULE: ./src/scripts/features/anchorSmoothScroll.js
...
;// CONCATENATED MODULE: ./src/scripts/features/btnUp.js
function btnUp() {
...
;// CONCATENATED MODULE: ./src/scripts/features/form-animation.js
function formAnimation() {
  var input = document.querySelectorAll('.input');
  input.forEach(function (item) {
    item.addEventListener('focus', function () {
      var id = item.id;
      var label = document.querySelector("[for=\"".concat(id, "\"]"));
...
;// CONCATENATED MODULE: ./src/scripts/blocks/burger.js
function burger() {
  var burger = document.querySelector('#burger');
  var list = document.querySelector('#list');
  var close = document.querySelector('#close-btn');
  var mediaLink = document.querySelectorAll('.link-media');
  burger.addEventListener('click', function () {
    list.classList.add('_active');
  });
  if (mediaLink) {
    for (var i = 0; i < mediaLink.length; i++) {
      var element = mediaLink[i];
...
;// CONCATENATED MODULE: ./src/scripts/blocks/map.js

function map() {
  ymaps_esm.load('https://api-maps.yandex.ru/2.1/?lang=en_US').then(function (maps) {
...
;// CONCATENATED MODULE: ./src/scripts/blocks/popup.js
function popup() {
  var btn = document.querySelector('.header__box__image-wrapper-1');
...
;// CONCATENATED MODULE: ./src/scripts/blocks/slider.js

core.use([Parallax, Scrollbar, Pagination]);
